...
class MANO(object):
    ...
    def __init__(self):
        ...
        self.joint_num = 21
        self.joints_name = ('Wrist', 'Thumb_1', 'Thumb_2', 'Thumb_3', 'Thumb_4', 'Index_1', 'Index_2', 'Index_3', 'Index_4', 'Middle_1', 'Middle_2', 'Middle_3',
                            'Middle_4', 'Ring_1', 'Ring_2', 'Ring_3', 'Ring_4', 'Pinky_1', 'Pinky_2', 'Pinky_3', 'Pinly_4')

        self.skeleton = ((0, 1), (0, 5), (0, 9), (0, 13), (0, 17), (1, 2), (2, 3), (3, 4), (5, 6), (6, 7), (7, 8), (9, 10), (10, 11), (11, 12), (13, 14), (14, 15),
                         (15, 16), (17, 18), (18, 19), (19, 20))
        self.root_joint_idx = self.joints_name.index("Wrist")

        # add fingertips to joint_regressor
        self.fingertip_vertex_idx = [745, 317, 444, 556, 673]  # mesh vertex idx (right hand) version0
        ...
        # self.fingertip_vertex_idx = [728, 353, 442, 576, 694]  # mesh vertex idx version1
    ...
    def get_layer(self):
        return ManoLayer(mano_root=osp.join("./common/utils/manopth", "mano", "models"), flat_hand_mean=False, use_pca=False)  # load right hand MANO model
